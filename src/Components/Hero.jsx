...
const Hero = () => {
  return (
    <section
      className="bg-[url(https://cdn.pixabay.com/photo/2019/01/09/13/24/red-rose-3923287_1280.jpg)] bg-no-repeat bg-cover bg-right text-gray-600 body-font h-screen"
      id="hero"
    >
